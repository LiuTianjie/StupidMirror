...
const chineseText = new Map([
  ...
  ["Put your phone on your Mac.", "把手机接上 Mac。"],
  ["Leave the rest to", "剩下的交给"],
  ["StupidMirror.", "StupidMirror。"],
  ["Mirror a real iOS or Android device. Then let local OCR, native UI semantics, and MCP make it operable by you and your AI agent.", "镜像真实 iOS 或 Android 设备，再通过本地 OCR、原生 UI 语义与 MCP，把它交给你和 AI 一起操作。"],
  ...
  ["Mirror and control multiple devices after activation.", "激活后可同时镜像与控制多台设备。"],
  ["Native speed", "原生速度"],
  ...
  ["macOS Vision OCR and native iOS/Android UI semantics replace visual guesswork with real targets.", "macOS Vision OCR 与 iOS / Android 原生 UI 语义协同，减少视觉模型盲猜。"],
  ["MCP control", "MCP 控制"],
  ["Tap, swipe, long-press, type, and clear — directly from an agent workflow.", "点击、滑动、长按、输入、清空，直接进入 Agent 工作流。"],
  ...
  ["It can operate the real device.", "它真的可以操作真机。"],
  ...
  ["The latest frame, local Vision OCR, and native UI semantics converge on the real target.", "最新镜像帧、本地 Vision OCR 与原生 UI 语义共同定位真实目标。"],
  ...
  ["Debug real hardware, reproduce issues, and rerun flows without bouncing between the phone and Mac.", "真机调试、问题复现、流程回归，不再在手机与 Mac 之间反复切换。"],
  ...
  ["Standalone mirrors fit recording, streaming, and demos; activation unlocks parallel iOS and Android workflows.", "独立镜像窗口适合录屏、直播与演示；激活后可并行管理 iOS 与 Android 设备。"],
  ["Device-ratio windows", "设备比例窗口"],
  ["Parallel devices", "多设备并行"],
  ["English and Chinese UI", "中英文界面"],
  ["Now put a real device", "现在，把真实设备"],
  ...
  ["Native iOS & Android mirroring and automation harness for macOS.", "原生 macOS iOS 与 Android 镜像自动化工具。"],
]);
...
const localeMetadata = {
  en: {
    lang: "en",
    title: "StupidMirror | Native iOS and Android mirroring and automation for macOS",
    description:
      "StupidMirror is a native macOS iOS and Android mirroring and automation harness with local OCR, MCP control, and multi-device workflows.",
    ogTitle: "StupidMirror | Make real mobile devices observable and operable",
    ogDescription: "Bring real iOS and Android devices to your Mac — and into Codex or Claude Code.",
    ogLocale: "en_US",
  },
  zh: {
    lang: "zh-CN",
    title: "StupidMirror｜让 iOS 与 Android 真机可观察、可操作",
    description:
      "StupidMirror 是一款原生 macOS iOS 与 Android 镜像自动化工具，支持本地 OCR、MCP 控制与多设备并行。",
    ogTitle: "StupidMirror｜让 iOS 与 Android 真机可观察、可操作",
    ogDescription: "把真实 iOS 与 Android 设备接入 Mac，也接入 Codex 与 Claude Code。",
    ogLocale: "zh_CN",
  },
};
